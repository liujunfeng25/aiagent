<template>
  <CockpitPanelBlue title="产业发展指标" title-en="INDUSTRY INDEX">
    <div ref="chartRef" class="region-chart-blue" />
  </CockpitPanelBlue>
</template>
...
function buildOption(data) {
  ...
  return {
    ...
    yAxis: {
      ...
      axisLabel: { color: '#e8eef8', fontSize: 11 },
    ...
    series: [{
      ...
      itemStyle: {
        ...
        color: new echarts.graphic.LinearGradient(0, 0, 1, 0, [
          ...
          { offset: 1, color: 'rgba(0,200,255,0.85)' },
        ]),
      },
    }],
  }
...
<style scoped>
.region-chart-blue { width: 100%; height: 100%; min-height: 160px; }
</style>
